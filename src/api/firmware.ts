...
const firmwareData: Record<FirmwareType, Firmware[]> = {
  mcu: [
    {
      id: 'fw-mcu-4', firmwareType: 'mcu', name: 'STM32 主控固件', version: 'v4.2.1',
      fileName: 'stm32-main-v4.2.1.bin', fileSize: 512_000,
    ...
    {
      id: 'fw-mcu-3', firmwareType: 'mcu', name: 'STM32 主控固件', version: 'v4.1.0',
      fileName: 'stm32-main-v4.1.0.bin', fileSize: 498_000,
      compatibleDevices: '温湿度传感器 / 环境监测仪 / 烟雾报警器',
    ...
    {
      id: 'fw-mcu-2', firmwareType: 'mcu', name: 'ESP32 通信模组固件', version: 'v3.0.0',
      fileName: 'esp32-comm-v3.0.0.bin', fileSize: 1_280_000,
    ...
    {
      id: 'fw-mcu-1', firmwareType: 'mcu', name: 'ESP32 通信模组固件', version: 'v2.8.1',
      fileName: 'esp32-comm-v2.8.1.bin', fileSize: 1_100_000,
      compatibleDevices: '智能摄像头 / 门禁控制器',
  ...
  fpga: [
    {
      id: 'fw-fpga-3', firmwareType: 'fpga', name: 'Xilinx 数据处理固件', version: 'v2.3.0',
      fileName: 'xilinx-datapath-v2.3.0.bit', fileSize: 8_500_000,
    ...
    {
      id: 'fw-fpga-2', firmwareType: 'fpga', name: 'Xilinx 数据处理固件', version: 'v2.2.0',
      fileName: 'xilinx-datapath-v2.2.0.bit', fileSize: 8_200_000,
      compatibleDevices: '智能摄像头 / 环境监测仪',
    ...
    {
      id: 'fw-fpga-1', firmwareType: 'fpga', name: '信号采集固件', version: 'v1.5.1',
      fileName: 'adc-fpga-v1.5.1.bit', fileSize: 3_200_000,
...
export async function getFirmwareList(firmwareType: FirmwareType): Promise<ApiResponse<Firmware[]>> {
  await new Promise((resolve) => setTimeout(resolve, 300));
  return { code: 0, data: firmwareData[firmwareType] || [], message: 'ok' };
}
...
export async function uploadFirmware(
  ...
  const prev = list.find((f) => f.status === 'latest' && f.name === name);
